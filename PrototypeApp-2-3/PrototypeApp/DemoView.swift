...
class DemoView: UIView {
    ...
    */
    ...
    func createSquare() {
        ...
        path.addLine(to: CGPoint(x: halfOfFrameW, y: halfOfFrameH+45))
        
        // Create the bottom line (bottom-left to bottom-right).
        path.addLine(to: CGPoint(x: halfOfFrameW+45, y: halfOfFrameH+45))
        
        // Create the vertical line from the bottom-right to the top-right side.
        path.addLine(to: CGPoint(x: halfOfFrameW+45, y: halfOfFrameH))
    ...
    override func draw(_ rect: CGRect) {
        ...
        UIColor.init(red: 255.0, green: 255.0, blue: 255.0, alpha: 0.2).setFill()
        path.fill()
